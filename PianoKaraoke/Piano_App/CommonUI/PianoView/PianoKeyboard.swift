...
@IBDesignable public class PianoKeyboard: UIView {
    ...
    private let lblConst: [String] = ["Đô", "Đô#",
                                      "Rê", "Rê#",
                                      "Mi",
                                      "Fa", "Fa#",
                                      "Sol", "Sol#",
...
//                let key = PianoKey(color: UIColor.white, rect: keyRect, type: .white, cornerRadius: keyCornerRadius, showNotes: showNotes, noteNumber: noteNumber, label: labels[noteNumber])
                let key = PianoKey(color: UIColor.white, rect: keyRect, type: .white, cornerRadius: keyCornerRadius, showNotes: showNotes, noteNumber: noteNumber, label: lblConst[index])
                keysArray[index] = key
...
//                let key = PianoKey(color: UIColor.black, rect: keyRect, type: .black, cornerRadius: keyCornerRadius, showNotes: showNotes, noteNumber: noteNumber, label: labels[noteNumber], blackKeyWidth: blackKeyWidth, blackKeyHeight: blackKeyHeight)
                let key = PianoKey(color: UIColor.black, rect: keyRect, type: .black, cornerRadius: keyCornerRadius, showNotes: showNotes, noteNumber: noteNumber, label: lblConst[index], blackKeyWidth: blackKeyWidth, blackKeyHeight: blackKeyHeight)
                keysArray[index] = key
                layer.addSublayer(key.imageLayer)
            }
        }
...
//        if text.contains("#") {
//            labelsBlack[midiNumber] = text
//        } else {
//            labelsWhite[midiNumber] = text
//        }
    }
