...
@IBDesignable open class SynthKeyboard: UIView, AKMIDIListener {
    ...
    let naturalNotesViet = ["Đô", "Rê", "Mi", "Fa", "Sol", "La", "Si"]
    let notesWithSharpsViet = ["Đô", "Đô#", "Rê", "Rê#", "Mi", "Fa", "Fa#", "Sol", "Sol#", "La", "La#", "Si"]
    
    var isShowViet: Bool = false
    ...
    func getNoteName(_ note: Int) -> String {
        ...
        if isShowViet {
            return notesWithSharpsViet[keyInOctave]
        }
    ...
    func getWhiteNoteName(_ keyIndex: Int) -> String {
        if isShowViet {
            return naturalNotesViet[keyIndex]
        }
