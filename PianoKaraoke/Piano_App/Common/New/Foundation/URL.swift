...
public extension URL {
    ...
    func addPrefix(_ prefix: String) -> URL? {
        if let _ = scheme {
            return self
        }
        else {
            let new = "\(prefix)://" + absoluteString
...
extension URL {
    ...
    private func _isAnimatedImage(_ imageData: Data) -> Bool {
    ...
    func isGIF() -> Bool {
        if pathExtension.lowercased() == "gif" {
            return true
        }
        return false
    }
    ...
    func isJPEG() -> Bool {
        return self.pathExtension.lowercased() == "jpeg"
    }
    
    func isPNG() -> Bool {
        return self.pathExtension.lowercased() == "png"
    }
}
