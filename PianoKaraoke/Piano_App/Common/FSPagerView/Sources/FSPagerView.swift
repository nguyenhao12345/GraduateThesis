...
open class FSPagerView: UIView,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    // Duration animation scrolling
    var durationAnimated: CGFloat?
    ...
    fileprivate func flipNext(sender: Timer?) {
        ...
        if let value = durationAnimated {
            self.collectionView.setValue(value, forKey: "contentOffsetAnimationDuration")
        }
