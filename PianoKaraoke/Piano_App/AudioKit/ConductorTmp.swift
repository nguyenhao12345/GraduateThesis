...
class ConductorTmp {
    ...
    static let shared = ConductorTmp()
...
//    lazy var plot: AKNodeFFTPlot = {
//        let node = AKNodeFFTPlot(AudioKit.output, frame: .zero)
//        node.shouldFill = true
//        node.shouldMirror = true
//        node.shouldCenterYAxis = true
//        node.color = #colorLiteral(red: 0.537254902, green: 0.9019607843, blue: 0.9764705882, alpha: 1)
//        return node
//    }()
    init() {
